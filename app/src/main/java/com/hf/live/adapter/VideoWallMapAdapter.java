...
public class VideoWallMapAdapter extends BaseAdapter{
	...
	public VideoWallMapAdapter(Context context, List<PhotoDto> mArrayList) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.adapter_video_wall_map, null);
