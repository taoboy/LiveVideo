 ...
 * 图片列表
 */
public class SelectAlbumPictureActivity extends BaseActivity implements View.OnClickListener {

    private Context mContext = null;
    private LinearLayout llBack = null;
    private TextView tvTitle = null;
    private GridView gridView;
    private SelectAlbumPictureAdapter adapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_album_picture);
        mContext = this;
        initWidget();
        initGridView();
    }
    ...
    private void initGridView() {
        ...
        adapter = new SelectAlbumPictureAdapter(mContext, mList);
