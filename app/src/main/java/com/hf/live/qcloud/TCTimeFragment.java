...
import com.hf.live.activity.VideoEditDetailActivity;
...
public class TCTimeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mVideoProgressController = ((VideoEditDetailActivity) getActivity()).getVideoProgressViewController();
    ...
    private void setRepeatSliderView() {
        if (mRepeatSlider == null) {
            ...
            ((VideoEditDetailActivity) getActivity()).previewAtTime(currentPts);

            mRepeatSlider = new SliderViewContainer(getActivity());
            ...
            mRepeatSlider.setOnStartTimeChangedListener(new SliderViewContainer.OnStartTimeChangedListener() {
                ...
                public void onStartTimeMsChanged(long timeMs) {
                    ...
                    repeatList.add(repeat);
                    mTXVideoEditer.setRepeatPlay(repeatList);
                    ((VideoEditDetailActivity) getActivity()).previewAtTime(timeMs);
                    // 进度条移动到当前位置
    ...
    private void initSpeedLayout() {
        if (mSpeedSlider == null) {
            ...
            mSpeedSlider = new SliderViewContainer(getActivity());
...
//                    mWorkLoadingProgress.show(getFragmentManager(), "reverse_loading_fragment");
                ...
                cancelSetEffect();
                showReverseLayout();
                ((VideoEditDetailActivity) getActivity()).stopPlay();
    ...
    private void cancelRepeatEffect() {
        ...
        ((VideoEditDetailActivity) getActivity()).restartPlay();
    }
    ...
    private void cancelReverseEffect() {
        ...
        ((VideoEditDetailActivity) getActivity()).switchReverse();
        ((VideoEditDetailActivity) getActivity()).restartPlay();
    }
