...
public class TCMotionFragment extends Fragment implements View.OnClickListener, View.OnTouchListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mActivityVideoProgressController = ((VideoEditDetailActivity) getActivity()).getVideoProgressViewController();
        initViews(view);
    }
    ...
    private void initViews(View view) {
        ...
        mColorfulProgress = new ColorfulProgress(getActivity());
    ...
    private void deleteLastMotion() {
        ...
        if (markInfo != null) {
            ...
            VideoEditDetailActivity parentActivity = (VideoEditDetailActivity) getActivity();
    ...
    private void pressMotion(int type) {
        ...
        mStartMark = true;
        ((VideoEditDetailActivity) getActivity()).startPlayAccordingState(currentTime, TCVideoEditerWrapper.getInstance().getCutterEndTime());
    ...
    private void upMotion(int type) {
        ...
        // 暂停播放
        ((VideoEditDetailActivity) getActivity()).pausePlay();
        // 进度条结束标记
