...
public class BeautySettingPannel extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    private ArrayList<String> mFirstGradleArrayString = new ArrayList<>();
    private ArrayList<String> mSencodeGradleArrayString = new ArrayList<>();
...
//    };
    ...
    UploadDialog mCustomProgressDialog;
    ...
    public BeautySettingPannel(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.layout_beauty_pannel, this);
        mContext = context;
        initView(view);
    }
                    ...
                    public void onClick(View view) {
                        ...
                        for (int i = 0; i < mFirstGradleAdapter.getCount(); i++) {
                            ...
                            if (v instanceof TextView) {
                                if (i == index) {
                                    ((TextView) v).setTextColor(mContext.getResources().getColor(R.color.red));
                                } else {
                                    ...
                                    public void onDownloadProgress(final int progress) {
                                        ((Activity)mContext).runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                if(mCustomProgressDialog == null){
                                                    mCustomProgressDialog = new UploadDialog(mContext);
                                                ...
                                                mCustomProgressDialog.setPercent(progress);
                                            }
                                        });
                                    }
